	...
	<!-- hidden field ----------------------------->
		<table border="1" style="width:90%; margin:auto; margin-top:3em">
			...
			<tr>
				...
				<input type="number" name="hp1" value="<%=user.getHp1()%>" id="hp1" placeholder="HP1">-
				<input type="number" name="hp2" value="<%=user.getHp2()%>" id="hp2" placeholder="HP2">-
				<input type="number" name="hp3" value="<%=user.getHp3()%>" id="hp3" placeholder="HP3">
			...
			<tr>
				...
				<td width="80%">
				<b class="state<%=user.getStatus()%>"><%=user.getStatusStr() %></b><br>
