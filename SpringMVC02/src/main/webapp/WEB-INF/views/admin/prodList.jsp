        ...
        <div class="col-md-12">
           ...
           <table class="table table-striped" id="products">
              ...
              <c:forEach var="prod" items="${prodArr}">
                 <tr>   
                    <td>${prod.pnum}</td>
                    <td>${prod.upCg_name}>${prod.downCg_name}
                    </td>
                    <td>${prod.pname}</td>
                    <td width="15%">
                    <a href="a" target="_blank">
                   	<img src="../resources/product_images/${prod.pimage1}" style="width:90%; margin:auto" class="img-fluid">
                    </a>
                    </td>
                    <td>
                    <del>정  가: <fmt:formatNumber value="${prod.price}" pattern="###,###" />원</del> 
                    <br>
                    <b class="text-primary">판매가 :<fmt:formatNumber value="${prod.saleprice}" pattern="###,###" />원</b><br>
