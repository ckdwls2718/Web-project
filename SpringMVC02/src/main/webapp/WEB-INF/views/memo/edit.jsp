	...
	<form name="frm" action="MemoEdit" method="post">
		<table class="table mt-3" >
			...
			<tr>
				...
				<td width="80%">
					<input type="text" name="name"  value="${memo.name}"  placeholder="Name" class="form-control">
				</td>
			</tr>
			<tr>
				<td width="20%"><b>메모 내용</b></td>
				<td width="80%">
					<input type="text" name="msg"  value="${memo.msg}"   placeholder="Message" class="form-control">
				</td>
			</tr>
			<tr>
				<td colspan="2" class="text-center">
					...
					<button type="button" class="btn btn-success" onclick="location.href='memoList'">목록 가기</button>			
				</td>
			</tr>
		</table>	
	</form>
